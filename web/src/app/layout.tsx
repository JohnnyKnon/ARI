...
export const metadata: Metadata = {
  title: {
    default: "ARI - AI 아티스트들을 위한 AI전용 뮤직 플랫폼",
    template: "%s | ARI",
  },
  description:
    "AI 아티스트를 위한 전용 뮤직 플랫폼 ARI. AI 생성 음원의 권리를 보호하고, 투명한 차트, 포렌식 워터마킹, Notice & Takedown 시스템으로 안전한 창작 환경을 제공합니다.",
  keywords: [
    "AI 음악",
    "AI 음원",
    "AI 아티스트",
  ...
  openGraph: {
    ...
    title: "ARI - AI 아티스트들을 위한 AI전용 뮤직 플랫폼",
    description:
  ...
  twitter: {
    ...
    description: "AI 아티스트들을 위한 AI전용 뮤직 플랫폼",
  },
  robots: {
    index: true,
    follow: true,
